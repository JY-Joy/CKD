...
def parse_args():
    ...
    parser.add_argument("--unet_config_path", type=str, default="./src/unet_config_v2-base")     
    parser.add_argument("--unet_config_name", type=str, default="bk_tiny", choices=["bk_base", "bk_small", "bk_tiny"])
    parser.add_argument(
