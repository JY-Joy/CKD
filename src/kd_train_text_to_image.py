...
def parse_args():
    ...
    parser.add_argument("--validation_prompt", type=str, default="a golden vase with different flowers")
...
def main():
    ...
    unet = UNet2DConditionModel.from_pretrained(
        args.bk_model_name_or_path, subfolder="unet", revision=args.revision,
    )
    ...
    dataset = train_dataset = load_dataset(
        args.train_data_dir,
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if (args.validation_prompt is not None) and (step % args.validation_steps == 0) and accelerator.is_main_process:
                logger.info(
                ...
                #     for kk in range(args.num_validation_images):
